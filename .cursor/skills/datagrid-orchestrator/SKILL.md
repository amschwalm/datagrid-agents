...
Datagrid workspace with an API key and it works. This is the Cursor orchestrator
for this repo.

```
.cursor/skills/datagrid-orchestrator/
├── SKILL.md
├── scripts/
...
`.cursor/skills/datagrid-orchestrator/` (examples below use `scripts/` as if
